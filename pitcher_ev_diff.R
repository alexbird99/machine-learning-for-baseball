# calculate pitcher Exit Velocity difference between 2016 and 2017
#
# Statcast Search
...
ev16 <- read.csv('csv\\2016_P_INPLAY.csv', fileEncoding = "UTF-8-BOM")
ev17 <- read.csv('csv\\2017_P_INPLAY.csv', fileEncoding = "UTF-8-BOM")
...
index <- result$pitches.x > 120 & result$pitches.y > 30
...
print("pitcher Avg EV (Average Exit Velocity) (mph)")
